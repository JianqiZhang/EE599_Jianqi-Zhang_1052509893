...
HD_PWD='D:/XilinxPorject/Assignment1_Q1_OddevenSort/Assignment1_Q1_OddevenSort.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OddevenSort.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OddevenSort.tcl
