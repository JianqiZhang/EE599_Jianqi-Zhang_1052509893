...
HD_PWD='D:/XilinxPorject/Assignment1_Q2_MatrixMul/Assignment1_Q2_MatrixMul.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MulandAddTree.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MulandAddTree.tcl
